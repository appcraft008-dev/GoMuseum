        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            ToggleButtons(
              ...
              borderRadius:
                  const BorderRadius.all(Radius.circular(GMRadius.pill)),
            ...
            const _PlanCard(
                ...
                subtitle: 'Faster answers • Premium voices'),
            const SizedBox(height: GMSpace.s4),
            Row(children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      ...
                      shape: const RoundedRectangleBorder(
                          borderRadius:
                              BorderRadius.all(Radius.circular(GMRadius.md)))),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                blurRadius: 16, offset: Offset(0, 6), color: Color(0x12000000))
          ]),
      child: Row(children: [
        ...
        const Expanded(
          ...
          Text('Unlimited recognition',
              style: TextStyle(fontWeight: FontWeight.w600)),
          SizedBox(height: 4),
          Text('Faster answers • Premium voices',
              style: TextStyle(color: Color(GMColors.textSecondary))),
        ]))
      ]),
    );
  }
