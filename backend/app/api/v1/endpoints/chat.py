...
class ChatRequest(BaseModel):
    ...
    artwork_id: Optional[str] = Field(
        None, description="ID of the artwork being discussed"
    )
    context: Optional[str] = Field(
        None, description="Additional context about the artwork"
    )
...
class ChatResponse(BaseModel):
    ...
    sources: Optional[list[str]] = Field(
        None, description="Information sources referenced"
    )
