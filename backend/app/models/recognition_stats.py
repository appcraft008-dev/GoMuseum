...
from sqlalchemy import CheckConstraint, Column, Date, Float, Index, Integer
...
class RecognitionStats(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="check_cache_sum_equals_total",
        ),
        CheckConstraint(
            "avg_response_time >= 0", name="check_avg_response_time_positive"
        ),
        CheckConstraint(
            "p95_response_time >= 0", name="check_p95_response_time_positive"
        ),
        ...
        Index(
            "ix_recognition_stats_date_desc", "date", postgresql_ops={"date": "DESC"}
        ),
    )
