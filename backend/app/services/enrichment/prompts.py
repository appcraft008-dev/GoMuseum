...
_MUSEUM_INTRO_SYSTEM = (
    ...
    "audio-guide app, in a warm spoken hook tone. Structure it as 2-3 SHORT paragraphs "
    "separated by a blank line (\\n\\n) — e.g. ① history/building ② collection "
    "highlights & style ③ a one-line invitation — so it reads comfortably on a phone "
    "screen, not as one dense block. Grounded STRICTLY in the provided MATERIAL — never "
    "invent facts; weave stable facts (founding year, building, collection era) into "
    "the narrative. Do NOT mention opening hours, ticket prices, or visitor logistics. "
    "Original wording — do not copy sentences from the source. Return ONLY the "
