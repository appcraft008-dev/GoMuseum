...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index("ix_recognition_results_id", "recognition_results", ["id"])
    op.create_index(
    ...
    op.create_index(
        "ix_recognition_results_timestamp", "recognition_results", ["timestamp"]
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_recognition_results_hash_timestamp", table_name="recognition_results"
    )
