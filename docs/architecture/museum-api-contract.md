...
- 语音 = **识别出来的那些作品**的主讲解段,可无限重播、永不弹墙
  (2026-09-19 起;清单存 `user_benefits.free_audio_qids`,解锁写在识别扣费的同一处)
...
5. **权益判据别挂在会被别的功能清空的数据上**(2026-09-19)。"免费语音跟着识别走"
...
- 2026-09-19:**免费语音改为跟着识别走**,音频闸门补纪律 2/5、纪律 1-3 随之改写。
