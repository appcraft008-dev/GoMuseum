...
- [x] Node.js 22.20.0 + npm 10.4.0
- [x] Python 3.11.7 + pip
- [x] Docker 28.3.3 + Docker Compose 2.24.5
- [x] PostgreSQL 16.1
- [x] Redis 8.2.1
- [x] Git 2.50.0
...
# 验证各项依赖
verify_version "node --version" "v22.20.0"
verify_version "python3 --version" "Python 3.11.7"
verify_version "docker --version" "Docker version 28"
verify_version "psql --version" "psql (PostgreSQL) 16"
verify_version "redis-server --version" "Redis server v=8.2"
