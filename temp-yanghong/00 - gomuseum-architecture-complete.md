...
交互次数: 36-48次
任务:
  Step 0 - 项目初始化: 30K tokens | 3-5次交互
...
交互次数: 36-48次
任务:
  Step 6 - 缓存系统: 40K tokens | 5-7次交互
  Step 7 - 多级缓存: 35K tokens | 5-6次交互
  Step 8 - 错误处理: 30K tokens | 4-6次交互
验收:
  - 响应时间 < 5秒
  - 缓存命中率 > 60%
...
交互次数: 16-21次
任务:
  Step 9 - 离线包: 45K tokens | 6-8次交互
  Step 10 - 支付集成: 40K tokens | 5-7次交互
验收:
  - 支持离线包
  - 离线包功能正常
  - 通过谷歌和苹果GPB & IAP支付功能购买叠加包
```
